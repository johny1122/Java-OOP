...
class Book {
	...
	/*-----  Constants  ------*/
	/**
	 * The return value if there is no current borrower of the book
	 */
	final static int NO_BORROWER = -1;
	 ...
	 * borrowing it.
	 * @param borrowerId The given Id of the current borrower of the book
	 */
